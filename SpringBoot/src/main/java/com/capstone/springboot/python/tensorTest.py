...
print("in 13")
dir="C:/Users/user/IdeaProjects/Capstone/src/main/java/com/capstone/springboot/python/data_out/checkpoint/cnn_model"
model_fn2 = tf.estimator.Estimator(model_fn, model_dir = dir)
    ### predict 계산
